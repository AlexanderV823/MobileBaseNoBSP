...
//Итоговая работа по модулю Мобильная разработка в 1С
	...
	Пока Выборка.Следующий() Цикл
		...
		ДвоичныеДанныеФотоСтрока = Base64Строка(ДвоичныеДанныеФото); //Двоичные данные просто строкой нельзя отправить. Нужно конвертировать в строку Base64.
		
		ДокументДоставки.Вставить("ФотоДоставки", Строка(ДвоичныеДанныеФотоСтрока));
